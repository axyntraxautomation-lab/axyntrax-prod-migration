...
- **Cecilia Suite (Module Management):** Manages industry-specific modules. Offers 30-day free demos with automated license key generation and expiration tracking. Uses Gemini `gemini-2.5-flash` for classification in Gmail automation.
