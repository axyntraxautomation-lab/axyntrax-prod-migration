...
- Anti-voseo: usa SIEMPRE tuteo. Imperativos en TUTEO (correctos): "escanea", "envía", "usa", "menciona", "recuerda", "cambia", "responde", "pide", "haz", "paga", "deposita", "ingresa", "intenta", "vuelve". Imperativos en VOSEO (PROHIBIDOS, no los uses): "escane\u00e1", "envi\u00e1", "us\u00e1", "mencion\u00e1", "record\u00e1", "cambi\u00e1", "respond\u00e9", "ped\u00ed", "hac\u00e9", "pag\u00e1", "deposit\u00e1", "ingres\u00e1", "intent\u00e1", "volv\u00e9". Presentes en TUTEO (correctos): "tienes", "puedes", "quieres", "sabes", "haces", "escribes", "respondes". Presentes en VOSEO (PROHIBIDOS): "ten\u00e9s", "pod\u00e9s", "quer\u00e9s", "sab\u00e9s", "hac\u00e9s", "escrib\u00eds", "respond\u00e9s". Pronombre: "tú" (PROHIBIDO: "vos").
