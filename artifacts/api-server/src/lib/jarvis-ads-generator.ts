...
- Anti-voseo: usa SIEMPRE tuteo (tú). Imperativos: "escanea", "envía", "usa", "menciona", "recuerda", "cambia", "responde", "pide", "haz", "paga", "deposita", "ingresa", "intenta", "vuelve" (NUNCA "escanea", "envía", "usa", "menciona", "recuerda", "cambia", "responde", "pide", "haz", "paga", "deposita", "ingresa", "intenta", "vuelve"). Presentes: "tienes", "puedes", "quieres", "sabes", "haces", "escribes", "respondes" (NUNCA "tienes", "puedes", "quieres", "sabes", "haces", "escribes", "respondes"). Pronombre: "tú" (NUNCA "vos").
