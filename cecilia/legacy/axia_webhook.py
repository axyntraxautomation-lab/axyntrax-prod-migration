                ...
                try {
                    ...
                    setTimeout(() => {
                        ...
                        if (text.toLowerCase().includes("cita") || text.toLowerCase().includes("turno")) {
                            ...
                            fallbackMsg = "Hola, Carlos. Te comento que nuestros planes van desde S/. 199/mes (Starter) hasta S/. 799/mes (Diamante). Mis sistemas de cotización automática están en mantenimiento por alta demanda, pero puedes registrarte gratis en www.axyntrax-automation.net para activar tu demo de 30 días 🚀.";
                        }
